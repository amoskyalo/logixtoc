...
const AssignedProductsForm = ({
  ...
  const validationSchema = () =>
    Yup.object().shape({
      productTypeArray: Yup.array().min(
        1,
            ...
            <Form>
              <Stack spacing={3}>
                ...
                <AutoCompleteField
                  ...
                  label="Products"
                  helperText={
                    touched.productTypeArray && errors.productTypeArray
                  }
                  error={
                    touched.productTypeArray && Boolean(errors.productTypeArray)
                  }
