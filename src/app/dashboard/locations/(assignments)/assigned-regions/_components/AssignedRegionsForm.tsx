...
const AssignedRegionsForm = ({
  ...
  const validationSchema = () =>
    Yup.object().shape({
      ...
      vendorLocationArrays: Yup.array().min(
        1,
            ...
            <Form>
              <Stack spacing={3}>
                <SelectField
                  ...
                  error={
                    touched.vendorRegionID && Boolean(errors.vendorRegionID)
                  }
                ...
                <AutoCompleteField
                  options={locations.map(
                    ({ VendorLocationID, VendorLocationName }) => ({
                  ...
                  error={
                    ...
                    Boolean(errors.vendorLocationArrays)
                  }
                  helperText={
                    touched.vendorLocationArrays && errors.vendorLocationArrays
                  }
                />
