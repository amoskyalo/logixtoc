        ...
        >
            ...
            <Grid container spacing={4}>
                <Grid item md={8} xs={12}>
                    <DashboardProductPerfomanceChart DailyPerformanceArray={dashboardData?.DailyPerformanceArray ?? []} loading={isLoading} />
                </Grid>

                <Grid item md={4} xs={12}>
                    <DashboardSalesPerformanceChart PerformanceArray={dashboardData?.PerformanceArray ?? []} loading={isLoading} />
                </Grid>
            </Grid>

            <Grid container spacing={4}>
                <DashboardDeliveryPlanTable loading={isLoading} rows={dashboardData?.LatestDeliveryPlanArray ?? []} />
                <DashboardStockMovementTable loading={isLoading} rows={dashboardData?.LatestStockMovementArray ?? []} />
            </Grid>
        </Box>
    );
};
